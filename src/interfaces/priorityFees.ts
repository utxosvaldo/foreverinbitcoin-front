// To parse this data:
//
//   import { Convert, PriorityFees } from "./file";
//
//   const priorityFees = Convert.toPriorityFees(json);
//
...
export class ConvertPF {
    public static toPriorityFees(json: string): PriorityFees {
        return cast(JSON.parse(json), r("PriorityFees"));
    }

    public static priorityFeesToJson(value: PriorityFees): string {
        return JSON.stringify(uncast(value, r("PriorityFees")), null, 2);
    }
}
